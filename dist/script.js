...
const ACTIONS = [TOGGLE_REVIEWED];

// classnames
const CHECKBOX_CLASS_NAME = 'js-reviewed-checkbox';
const LABEL_CLASS_NAME = 'js-reviewed-toggle';
  ...
  forEachEl(files, file => {
    ...
    forEachEl(anchors, anchor => {
      ...
      if (match) {
        ...
        const reviewedLabels = includesClassName(labels, LABEL_CLASS_NAME);

        forFirstEl(reviewedLabels, label => {
          const checkboxes = label.getElementsByTagName('input');
          const reviewedCheckboxes = includesClassName(
            checkboxes,
            CHECKBOX_CLASS_NAME
          );
...
function actions(action) {
  ...
  switch (type) {
    ...
    default:
      console.warn(
        `no action found for \`${type}\`. Expected one of ${join(
          ACTIONS,
          ', '
        )}.`,
        {
